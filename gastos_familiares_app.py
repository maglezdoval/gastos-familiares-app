...
# ⚙️ Mostrar configuración siempre
...
if uploaded_file:
    ...
    st.session_state["COMERCIOS"] = editar_lista("COMERCIO", st.session_state.get("COMERCIOS", sorted(df['COMERCIO'].dropna().unique().tolist())))
