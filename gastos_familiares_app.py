                ...
                if st.button("🤖 Sugerir CATEGORÍAS Faltantes", key="suggest_cats"):
                    ...
                    for index in indices_to_update:
                        ...
                        if sugg_result is not None:
                           ...
                           if sugg_cat and df_suggest.loc[index, cat_tab] == ph_cat_tab: df_suggest.loc[index, cat_tab] = sugg_cat; applied_c = True
                           if sugg_sub and df_suggest.loc[index, subcat_tab] == ph_sub_tab:
                               if applied_c or (sugg_cat is None and df_suggest.loc[index, cat_tab] != ph_cat_tab): df_suggest.loc[index, subcat_tab] = sugg_sub; applied_c = True
